...
export default function BottomNav({ active }) {
  ...
  const navs = [
    ...
    { id: 'profile', path: '/profile', label: 'Account', icon: <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2 M12 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z" /> },
  ];

  return (
    <div className="bottom-nav">
      {navs.map(n => {
        const isActive = active === n.id || location.pathname === n.path;
        return (
          <button 
            key={n.id} 
